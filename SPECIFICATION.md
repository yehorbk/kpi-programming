...
- [5\. Функціональність](#5-функціональність)
  ...
  - [5.2. Реєстрація аккаунту представника](#52-реєстрація-аккаунту-представника)
...
### 5.2. Реєстрація аккаунту представника
...
посилання на сервіс для бронювання та рейтингу користувачів. Усі дані (окрім рейтингу) надаються представником та є обов’язковими для заповнення,
