...
то допис буде видалено, а автор допису отримає попередження або навіть блокування аккаунта.
...
Доступ до модулю "створення публікації" має лише підтверджений аккаунт представника, а анонімні користувачі не мають доступу до
