...
try { 
  // console.dir({ res }); // Cause Exception!
  // console.dir({ entry: res[0] }); // Cause Exception!
  console.dir({ entry: res[0].toString} ); // Works fine
  console.dir({ properties: Object.getOwnPropertyNames(res[0].__proto__)} );
} catch (e) {
  console.dir(e);
}
